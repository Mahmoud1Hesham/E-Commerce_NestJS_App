...
<style type="text/css">
@media (max-width: 480px) {
.t35,.t40{mso-line-height-alt:0px!important;line-height:0!important;display:none!important}.t36{padding-top:43px!important}.t38{border:0!important;border-radius:0!important}.t33,.t9{width:320px!important}.t30{mso-line-height-alt:26px!important;line-height:26px!important}
}
</style>
<!--[if !mso]>-->
...
<tr>
<!--[if mso]>
<td width="400" class="t38" style="background-color:#FFFFFF;border:1px solid #CECECE;overflow:hidden;width:400px;border-radius:20px 20px 20px 20px;">
<![endif]-->
<!--[if !mso]>-->
<td class="t38" style="background-color:#FFFFFF;border:1px solid #CECECE;overflow:hidden;width:400px;border-radius:20px 20px 20px 20px;">
<!--<![endif]-->
<table class="t37" role="presentation" cellpadding="0" cellspacing="0" width="100%" style="width:100%;"><tr>
<td class="t36" style="padding:50px 40px 40px 40px;"><table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="width:100% !important;"><tr><td align="center">
...
<td class="t1"><a href="#" style="font-size:0px;" target="_blank"><img class="t0" style="display:block;border:0;height:auto;width:100%;Margin:0;max-width:100%;" width="60" height="60" alt="" src="./2.png"/></a></td>
</tr></table>
</td>
</tr></table>
...
<![endif]-->
<!--[if !mso]>-->
<td class="t21" style="overflow:hidden;width:154px;border-radius:8px 8px 8px 8px;">
<!--<![endif]-->
<table class="t20" role="presentation" cellpadding="0" cellspacing="0" width="100%" style="width:100%;"><tr>
<td class="t19" style="text-align:center; line-height:40px; mso-line-height-rule:exactly; mso-text-raise:8px; font-family: Inter, BlinkMacSystemFont, Segoe UI, Helvetica Neue, Arial, sans-serif; font-size: 20px; font-weight: bold; color: #FFFFFF; background-color: #0057FF; border-radius: 8px; padding: 10px 20px;">
   ${otp}
</td>
...
<tr>
<!--[if mso]>
<td width="318" class="t33" style="background-color:#F2EFF3;overflow:hidden;width:318px;border-radius:8px 8px 8px 8px;">
<![endif]-->
<!--[if !mso]>-->
<td class="t33" style="background-color:#F2EFF3;overflow:hidden;width:318px;border-radius:8px 8px 8px 8px;">
<!--<![endif]-->
<!-- <table class="t32" role="presentation" cellpadding="0" cellspacing="0" width="100%" style="width:100%;"><tr>
<td class="t31" style="padding:20px 30px 20px 30px;"><p class="t29" style="margin:0;Margin:0;font-family:Albert Sans,BlinkMacSystemFont,Segoe UI,Helvetica Neue,Arial,sans-serif;line-height:18px;font-weight:500;font-style:normal;font-size:12px;text-decoration:none;text-transform:none;direction:ltr;color:#84828E;text-align:center;mso-line-height-rule:exactly;mso-text-raise:2px;">Email specialists use X&#39;s intuitive tool to design emails for desktop and mobile, and let our smart algorithm generate HTML for use in their ESPs.</p></td>
</tr></table>
</td>
</tr></table>
</td></tr></table></td>
